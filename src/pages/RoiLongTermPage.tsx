...
import { Input, Input as Slider } from '@/components/ui/input';
    ...
    <div className="p-4 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle>Projeção de Valorização</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-80">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="valorInicial" type="number" defaultValue="500000" />
              </div>
              <div className="space-y-2">
                <label htmlFor="periodo" className="text-sm font-medium">
                  Período (anos)
                </label>
                <Input id="periodo" type="number" min="1" max="30" defaultValue="10" />
              </div>
              <div className="space-y-2">
                <label htmlFor="taxaBase" className="text-sm font-medium">
                  Taxa de Valorização Base (% a.a.)
                </label>
                <Input id="taxaBase" type="number" step="0.1" defaultValue="5.0" />
              </div>
              <Button 
                className="w-full bg-arca-purple hover:bg-arca-dark-purple"
              >
                Calcular Projeção
              </Button>
            </div>
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            <CardTitle>Análise de Fatores de Longo Prazo</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-medium text-lg mb-2">Fatores Econômicos</h3>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-medium text-lg mb-2">Desenvolvimento Urbano</h3>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li className="flex items-center">
                    <span className="h-2 w-2 rounded-full bg-green-500 mr-2"></span>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-medium text-lg mb-2">Perfil Demográfico</h3>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li className="flex items-center">
                    <span className="h-2 w-2 rounded-full bg-green-500 mr-2"></span>
